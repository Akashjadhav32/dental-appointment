...
def test_invalid_name_too_short():
    ...
    try:
        ...
        if response.status_code == 400:  # Express validation error
            ...
            log_test("Invalid Name (Too Short) Rejection", False, f"Expected 400, got {response.status_code}")
            return False
    except Exception as e:
...
def test_invalid_complaint_too_short():
    ...
    try:
        ...
        if response.status_code == 400:  # Express validation error
            ...
            log_test("Invalid Complaint (Too Short) Rejection", False, f"Expected 400, got {response.status_code}")
            return False
    except Exception as e:
